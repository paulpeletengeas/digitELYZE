...
const ThemeCardScreen = ({ route, navigation }) => {
    ...
    return isLoaded === true ? (
        <>
            ...
            <FindOutMorePopup sheetRef={sheetRef} index={dataIndex} data={fakeData} themeData={themeData} />
        </>
    ) : (
        <View />
    );
...
export default ThemeCardScreen;
